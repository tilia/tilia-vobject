...
module Tilia
  module VObject
    class Issue50Test < Minitest::Test
      def test_expand
        input = <<ICS
BEGIN:VCALENDAR
VERSION:2.0
...
ICS
        ...
        it = Tilia::VObject::Recur::EventIterator.new(vcal, '1aef0b27-3d92-4581-829a-11999dd36724')
        ...
        tz = ActiveSupport::TimeZone.new('Europe/Brussels')

        assert_equal(
          [
            tz.parse('2013-07-15 09:00:00'),
            tz.parse('2013-07-16 07:00:00'),
            tz.parse('2013-07-17 07:00:00'),
            tz.parse('2013-07-18 09:00:00'),
            tz.parse('2013-07-19 07:00:00')
          ], result
        )
      end
    end
