        ...
        expected = [
          {
            ...
            'recipient_name' => nil,
            'message'        => expected_ics
          }
        ]
        parse(nil, ics, expected, 'mailto:martin@fruux.com')
      end
